        ...
        <div class="admin-card p-6">
            ...
            <div class="admin-card p-4 mb-4">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <a href="{{ URL::signedRoute('admin.payments.download-proof', $proof->id) }}" target="_blank" class="btn-view text-xs">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                        Open Full
                    </a>
                </div>
                <div class="rounded-xl overflow-hidden border border-white/10">
                    <img src="{{ URL::signedRoute('admin.payments.download-proof', $proof->id) }}" alt="Payment Proof" class="w-full object-contain max-h-96">
                </div>
            </div>
            @empty
